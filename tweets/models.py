...
class Tweet(models.Model):
    ...
    user = models.ForeignKey(User, on_delete=models.CASCADE)    # throug TweetLike we are able to add manytomany field    # use the link for more understanding of through https://riptutorial.com/django/example/7838/with-a-through-model                
