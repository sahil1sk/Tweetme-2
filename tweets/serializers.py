...
class TweetCreateSerializer(serializers.ModelSerializer):
    ...
    def get_likes(self, obj):    # this function will return the total no of likes
        return obj.likes.count() 

    #def get_user(self, obj): # this function will return the user
     #   return obj.user.id
...
class TweetSerializer(serializers.ModelSerializer):
    ...
    class Meta:
        ...
        fields = [
                ...
                ] # is_retweet provide true or false it is basically that function which we make in the model.py file under Tweet model so that why we are able to use this here
